...
export default function FAQSection() {
  ...
  for (const key in t("faq.items", { returnObjects: true })) {
    if (
      Object.hasOwnProperty.call(t("faq.items", { returnObjects: true }), key)
    ) {
    ...
    <div className="py-12 bg-bacground/80">
      ...
      <div className="max-w-2xl mx-auto px-4">
        {shortFaqs.slice(0, 2).map((faq) => (
          <div key={faq.question} className="mb-4 border-b pb-4">
      ...
      <div className="flex justify-center">
        <Link
          href="/inside/faq"
          className="text-blue-600 hover:underline text-center self-center"
        >
          {t("faq.view_more")}
        </Link>
      </div>
